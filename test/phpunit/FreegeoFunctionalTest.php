...
/**
 * \file    test/phpunit/FreegeoFunctionalTest.php
 * \ingroup freegeo
 ...
 * @package Testfreegeo
 */
class FreegeoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/freegeo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('freegeo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/freegeo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('freegeo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('freegeowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFreegeo_FreegeoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFreegeo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
